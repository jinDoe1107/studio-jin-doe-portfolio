...
const artists = [
	...
	{ name: 'the Cabs', genre: 'Math Rock' },
	{ name: 'MR.BIG', genre: 'Hard Rock' },
	{ name: 'MOROHA', genre: 'Folk Hip-Hop' },
	{ name: 'Kenny Wayne Shepherd', genre: 'Blues Rock' },
	{ name: 'ペトロールズ', genre: 'Indie Rock' },
