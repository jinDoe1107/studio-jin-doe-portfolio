const translations = {
	ja: {
		...
		about: {
			sectionTitle: 'About',
			p1: 'はじめまして、jin doe です。システムエンジニアとして働きつつ、日常の隙間で音楽を作っています。',
	...
	en: {
		...
		about: {
			sectionTitle: 'About',
			p1: "Hi, I'm jin doe. I work as a software engineer and make music in the gaps of everyday life.",
